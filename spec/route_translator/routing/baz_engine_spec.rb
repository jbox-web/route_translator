...
RSpec.describe Baz::Engine, type: :routing do
  describe Baz::WelcomeController, type: :routing do
  ...
  describe Baz::ProductsController, type: :routing do
    routes { Baz::Engine.routes }
  ...
  describe Baz::PeopleController, type: :routing do
    routes { Baz::Engine.routes }
