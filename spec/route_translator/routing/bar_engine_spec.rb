...
RSpec.describe Bar::WelcomeController, type: :routing do
...
RSpec.describe Bar::ProductsController, type: :routing do
  routes { Bar::Engine.routes }
...
RSpec.describe Bar::PeopleController, type: :routing do
  routes { Bar::Engine.routes }
