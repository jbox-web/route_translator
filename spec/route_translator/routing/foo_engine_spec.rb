...
RSpec.describe Foo::Engine, type: :routing do
  describe Foo::WelcomeController, type: :routing do
  ...
  describe Foo::ProductsController, type: :routing do
    routes { Foo::Engine.routes }
  ...
  describe Foo::PeopleController, type: :routing do
    routes { Foo::Engine.routes }
